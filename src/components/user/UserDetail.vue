        ...
        <div class="users-bg2" style="padding:10px 0;background:linear-gradient(to right, #518ffc, #03a9f4);">
          <div class="users-bg2-l" style="width:100px;position: absolute;z-index: 999;">
            <input type="file" @change="changeAvatar" accept="image/*"
                   style="z-index: 1000;opacity:0;width: 80px;height: 80px;margin-left: 20px"/>
          </div>
          <div class="users-bg2-l" style="padding:35px 0 35px 10px;z-index: 1;">
            <div v-bind:style="{backgroundImage:'url(' + headUrl + ')'}"
                 style="margin-left:10px;width: 80px;height: 80px;border-radius:80px;background-position: center center;background-size: cover;background-repeat: no-repeat"></div>
          </div>
          <div @click="UserInformation" class="users-bg2-c user-info-name">{{nickName}}</div>
          <div @click="UserInformation" class="users-bg2-r" style="width: 10%;"><img src="../../images/users-djt.png">
          </div>
        </div>
      </div>
      ...
      <div class="v-simple-cropper">
        <div class="v-cropper-layer" ref="layer">
          <div class="layer-header" style="height:8%;background-color:#000;padding-bottom: 1px;">
            <button style="float:left;height:100%;width:49%;border:solid 1px #03a9f4;background-color:#03a9f4;"
                    @click="cancelHandle">取消
            </button>
            <button style="float:right;height:100%;width:49%;border:solid 1px #03a9f4;background-color:#03a9f4;"
                    @click="confirmHandle">裁剪
            </button>
          </div>
