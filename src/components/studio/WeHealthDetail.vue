<template>
  <div class="weHealthDetail">
    ...
    <button @click="openNewUrl()">点击跳转新连接</button>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openNewUrl() {
          var url = encodeURIComponent('http://www.yipong.com/userhome/sciencearticledetail?id=11&customerId=72998');
          this.$router.push({path: '/VHTMLPanel/' + url})
      }
    },
    props: {
      teamInfo: Object,
