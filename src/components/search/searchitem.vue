...
<template>
    <div class="live-item" @click="toLiveDetail">
        ...
        <div class="detail">
            ...
            <div class="button" onClick="event.cancelBubble = true" v-if="liveInfo.LiveStreamStateId == 0">
...
export default {
    ...
    mounted() {
       if(this.liveInfo.LiveStreamStateId == 1){
            this.state = "直播中"
       }
