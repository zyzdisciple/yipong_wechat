...
export default {
  ...
  updateCurrSessionMsgs(state, obj) {
    ...
    if (type === 'destroy') { // 清空会话消息
      ...
      if (msgLen > 0) {
        ...
        state.currSessionMsgs = [];
        for (let i = 0, L = obj.msg.length; i < L; i++) {
            state.currSessionMsgs.push(obj.msg[i]);
        }
      }
    }
  },
  ...
  updateChatroomAvatar(state, obj) {
    state.currChatroomAvatar = obj;
  },
  ...
  updateyipong(state, obj) {
    state.yipong = obj;
  },
  updatestudiolist(state, obj) {
    state.studiolist = obj;
  },
  updatevideolist(state, obj) {
    state.videolist = obj;
  },
  updatehistorylist(state, obj) {
    state.historylist = obj;
  },
  updateassocialist(state, obj) {
    state.associalist = obj;
  },
  updateprvlist(state, obj) {
    state.prvlist = obj;
  },
  updatestudiodetail(state, obj) {
    state.studiodetail = obj;
  },
   updateteamlist(state, obj) {
    state.teamlist = obj;
  },
   updateproit(state, obj) {
    state.proit = obj;
  },
  putMsgex(state, msg) {
    state.msgggg = msg;
